...
export class RelationUserProblem1635825532514 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "answers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "usedTime" integer NOT NULL, "numberTipsUsed" integer NOT NULL, "isCorrect" boolean NOT NULL, "problemId" uuid, "userId" uuid, CONSTRAINT "PK_9c32cec6c71e06da0254f2226c6" PRIMARY KEY ("id"))`);
